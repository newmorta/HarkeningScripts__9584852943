-- Ruta Original: StarterGui.SpeedGameUI.Modals.RobuxShopModal.ScrollingFrame.Boombox.NewBadge.RainbowGradient
-- Tipo: LocalScript
...
RunService.RenderStepped:Connect(function(p2) -- Line: 12
    -- upvalues: u1 (ref), UIGradient (copy), Size (copy)
    u1 = u1 + p2 * 0.5;
