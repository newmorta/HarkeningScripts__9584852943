-- Ruta Original: StarterPlayer.StarterPlayerScripts.Pièges.World2.Stage10_1
-- Tipo: LocalScript
...
for _, v in ipairs(CollectionService:GetTagged("Stage10Bridge")) do
    if v:IsA("Model") then
        connectTouch(v);
    end;
end;

CollectionService:GetInstanceAddedSignal("Stage10Bridge"):Connect(setupModel);